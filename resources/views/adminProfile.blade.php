  ...
  <body>
    ...
    <div id="container" >
        <section id="body-container">
          <div id="title-container"><h1 id="title">My Admin Profile</h1></div>

          <div class="profile-container">
            <img src="/uploads/avatars/{{$admin->avatar}}" alt="" style="width: 150px; height: 150px; float: left; border-radius: 50%; margin-right: 25px">
            <h2>{{ $admin->name }} profile</h2>
            <form class="" action="{{route('admin.profile.update.image.submit')}}" method="post" enctype="multipart/form-data">
            ...
            {{ Form::open(array('url' => '/profile/' . $admin->id, 'class' => 'pull-right')) }}
            <div class="form-group">
              <div class="form-content">
